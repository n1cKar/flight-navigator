...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Daham Lanka — Client Flight Tracker" },
      {
        name: "description",
        content:
          "Internal system for Daham Lanka (PVT) LTD to record client arrivals and share country-specific flight details with agents.",
      },
